...
-- `order_id` stores the human-friendly checkout order number (e.g. #1001, #1002).
...
--
-- `order_id` is the primary key and stores the checkout order number
-- generated by the POS (formatted as #1001, #1002, ... based on the
-- daily completed-sale counter offset by 1000).
--
...
-- `order_id` references `sales`.`order_id` (the checkout order number, e.g. #1001).
--
