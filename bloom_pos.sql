...
--
-- Indexes for table `showcase_bundles`
--
ALTER TABLE `showcase_bundles`
  ADD PRIMARY KEY (`showcase_id`);

--
-- Indexes for table `showcase_sales`
--
ALTER TABLE `showcase_sales`
  ADD PRIMARY KEY (`bestseller_id`),
  ADD KEY `idx_showcase_sale_date` (`sale_date`),
  ADD KEY `idx_showcase_id` (`showcase_id`),
  ADD KEY `fk_showcase_sales_sale` (`order_id`),
  ADD KEY `fk_showcase_sales_emp` (`employee_id`);
...
--
-- AUTO_INCREMENT for table `showcase_bundles`
--
ALTER TABLE `showcase_bundles`
  MODIFY `showcase_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `showcase_sales`
--
ALTER TABLE `showcase_sales`
  MODIFY `bestseller_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `session_history`
  ADD CONSTRAINT `fk_session_history_employee` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON UPDATE CASCADE;

--
-- Constraints for table `showcase_sales`
--
ALTER TABLE `showcase_sales`
  ADD CONSTRAINT `fk_showcase_sales_emp` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_showcase_sales_sale` FOREIGN KEY (`order_id`) REFERENCES `sales` (`order_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_showcase_sales_showcase` FOREIGN KEY (`showcase_id`) REFERENCES `showcase_bundles` (`showcase_id`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
